...
func BenchmarkBmux_Param(b *testing.B) {
	router := loadBmuxSingle("GET", "/user/{name}", bmuxHandler)
...
func BenchmarkBmux_Param5(b *testing.B) {
	router := loadBmuxSingle("GET", fiveBrace, bmuxHandler)
...
func BenchmarkBmux_Param20(b *testing.B) {
	router := loadBmuxSingle("GET", twentyBrace, bmuxHandler)
...
func BenchmarkBmux_ParamWrite(b *testing.B) {
	router := loadBmuxSingle("GET", "/user/{name}", bmuxHandlerTest)
