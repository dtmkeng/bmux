...
func init() {
	...
	calcMem("Bmux_github", func() {
		githubBmux = loadBmux(githubAPI)
	})
}
...
func BenchmarkBmux_GithubStatic(b *testing.B) {
	req, _ := http.NewRequest("GET", "/user/repos", nil)
	benchRequest(b, githubBmux, req)
}
func BenchmarkAero_GithubParam(b *testing.B) {
	req, _ := http.NewRequest("GET", "/repos/julienschmidt/httprouter/stargazers", nil)
	benchRequest(b, githubAero, req)
}
func BenchmarkBmux_GithubParam(b *testing.B) {
	req, _ := http.NewRequest("GET", "/repos/julienschmidt/httprouter/stargazers", nil)
	benchRequest(b, githubBmux, req)
}
...
func BenchmarkBmux_GithubAll(b *testing.B) {
	benchRoutes(b, githubBmux, githubAPI)
}
